//
//  CheckMotionViewController.swift
//  KAWAI
//
//  Created by 池田俊輝 on 2018/10/20.
...
class CheckMotionViewController: UIViewController {
    ...
    let semaphore = DispatchSemaphore(value: CheckMotionViewController.maxInflightBuffers)
...
//    }
    ...
    func setUpVision() {
        ...
        for _ in 0..<CheckMotionViewController.maxInflightBuffers {
...
extension CheckMotionViewController: VideoCaptureDelegate {
    func videoCapture(_ capture: VideoCapture, didCaptureVideoFrame pixelBuffer: CVPixelBuffer?, timestamp: CMTime) {
        ...
        if let pixelBuffer = pixelBuffer {
            ...
            inflightBuffer += 1
            if inflightBuffer >= CheckMotionViewController.maxInflightBuffers {
                inflightBuffer = 0
            }
